  ...
  <!--content--> 
	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			<h3 style="margin:5px 0 5px 5px;">Ubah Password Airline</h3>
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				<tr class="editTR" >
					<td class="tdTitle">ID Airline</td>
					<td><input name="nama" id="nama" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Password</td>
					<td><input name="pass" id="pass" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Kode Agen</td>
					<td><input name="kode" id="kode" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
			...
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_airlines/password';" />
...
<script>
	function load_data_password(uri){
		$.ajax({
			type : "GET",
			url: uri,
			dataType: "json",
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_password("'.base_url().'index.php/admin/airline_password_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/airline_password_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
