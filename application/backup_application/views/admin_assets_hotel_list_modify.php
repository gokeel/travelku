	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			...
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				...
				<tr class="editTR" >
					<td class="tdTitle">Telp no</td>
					<td><input name="telp" id="telp" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">ID City</td>
					<td><input name="idcity" id="idcity" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
			...
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_hotel/hotel_list';" />
...
<script>
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_hotel("'.base_url().'index.php/admin/hotel_list_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/hotel_list_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
