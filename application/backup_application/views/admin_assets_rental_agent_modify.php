  ...
  <!--content--> 
	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			<h3 style="margin:5px 0 5px 5px;">Ubah Data Rental Agent</h3>
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				<tr class="editTR" >
					<td class="tdTitle">Rental Agent Name</td>
				...
				<tr class="editTR" >
					<td class="tdTitle">Telp Rental Agent</td>
			...
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_rental/agent';" />
...
<script>
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_room_hotel("'.base_url().'index.php/admin/rental_agent_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/rental_agent_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
