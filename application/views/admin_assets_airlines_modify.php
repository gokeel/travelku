	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			...
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				...
				<tr class="editTR" >
					<td class="tdTitle">Kode</td>
					<td><input name="kode" id="kode" type="text" value="" size="60"></td>
				</tr>
			</table>
			<div id="status"></div>
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_airlines/airlines';" />
...
<script>
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_ym("'.base_url().'index.php/admin/airline_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/airline_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
