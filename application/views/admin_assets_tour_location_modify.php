  ...
  <!--content--> 
	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			<h3 style="margin:5px 0 5px 5px;">Ubah Data Tour Location/h3>
			...
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_tour/location';" />
...
<script>
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_room_hotel("'.base_url().'index.php/admin/tour_location_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/tour_location_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
