  ...
  <!--content--> 
	...
	<div class="frametab">
		<form class="myform" id="edit_form">
			<h3 style="margin:5px 0 5px 5px;">Ubah Data Travel Trayek/h3>
			<table cellpadding="5"  id="table-modify"   cellspacing="0" border="0px" bgcolor="#FFFFFF" class="myTable" >
				...
				<tr class="editTR" >
					<td class="tdTitle">Mobil</td>
					<td><input name="mobil" id="mobil" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Kota Dari</td>
					<td><input name="kota_dari" id="kota_dari" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Kota Ke</td>
					<td><input name="kota_ke" id="kota_ke" type="text" value="" size="60"></td>
				</tr>
				<tr class="editTR" >
					<td class="tdTitle">Jam</td>
					<td><input name="jam" id="jam" type="text" value="" size="60"></td>
				</tr>
				
			</table>
			<div id="status"></div>
			<div class="formFooter">
				<input class="mybutton" style="float:left" name="dbproses" type="button" value="Cancel" onclick="document.location.href='<?php echo base_url();?>index.php/admin/assets_travel/trayek';" />
...
<script>
		...
		$.ajax({
			...
			success:function(data){
				for(var i=0; i<data.length;i++){
					...
					$('#mobil').val(data[i].mobil);
					$('#kota_dari').val(data[i].kota_dari);
					$('#kota_ke').val(data[i].kota_ke);
					$('#jam').val(data[i].jam);
				}
			}
		})
	...
	$( window ).load(function() {
	 <?php
		...
		echo 'load_data_room_hotel("'.base_url().'index.php/admin/travel_trayek_details/'.$id.'");';
	 ?>	
	});
	$(document).ready(function() {
		$('#edit_data').click(function(event) {
			...
			$.ajax({
				type : "GET",
				url: "<?php echo base_url().'index.php/admin/travel_trayek_edit/'.$id;?>",
				data: form,
				cache: false,
				dataType: "json",
				success:function(data){
