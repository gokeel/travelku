		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 offset-0">
				...
				<div class="padding30 grey">
					<span class="size16px bold dark left">Syarat dan Ketentuan yang Berlaku</span>
...
<script>
	...
	function load_posts(){
		var request = '<?php echo base_url();?>index.php/webfront/get_post_by_category/term-condition/0/1';
		$.ajax({
			type : "GET",
			async: false,
			url: request,
