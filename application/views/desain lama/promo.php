                        ...
                        <div class="container">
                            ...
                            <div class="page-title-content">
                                ...
                                <p class="page-description">
									Berbagai paket promo dari maskapai penerbangan maupun hotel-hotel berbintang kami rangkum untuk anda. Informasi yang akan membantu anda menghemat budget perjalanan wisata atau tugas dinas, sehingga anda dapat menggunakan budget akomodasi untuk hal-hal yang lain.
								</p>
                            </div>
                        </div>
                    </div>
...
<div class="span8 boxfix">
            ...
            <div class="portfolio-wrapper portfolio-four isotope listhotel">
       		...
       		<div class="portfolio-item hoverdir ecofriendly isotope-item boxfix">
           	 	<div class="portfolio-overlay" style="transition: all 300ms ease; -webkit-transition: all 300ms ease; left: 0px; top: -100%; display: block;"></div>
                  	<span class="portfolio-single-link">
                        <span class="news-img-mini">  <img src="<?php echo IMAGES_DIR;?>/hotel1_l.jpg" alt="The Sunset Bali Hotel">  </span>
                        <strong><a href="http://bebasterbang.com/theme/index.html#" class="title">The Sunset Bali Hotel</a></strong> <br>
                        <span class="starsin3">3-Stars Hotel</span><br>
                        Bali<br>
                        <span class="redbox">Discount 20%</span><br>
                        <strong>IDR 650.000,00</strong>    
              ...
              <div class="portfolio-item hoverdir ecofriendly isotope-item boxfix">
              	<div class="portfolio-overlay" style="left: 0px; top: -100%; display: block; transition: all 300ms ease; -webkit-transition: all 300ms ease;">tess</div>
                  <span class="portfolio-single-link">
                        <span class="news-img-mini"> <img src="<?php echo IMAGES_DIR;?>/hotel2_l.jpg" alt="The Sunset Bali Hotel">  </span>
                        <strong><a href="http://bebasterbang.com/theme/index.html#" class="title">Favehotel Solo Baru</a></strong> <br>
                        <span class="starsin2">2-Stars Hotel</span><br>
                        Solo<br>
                        <span class="redbox">Discount 20%</span><br>
                        <strong>IDR 450.000,00</strong>  
             ...
             <div class="portfolio-item hoverdir ecofriendly isotope-item boxfix">
                <span class="portfolio-single-link">
                    <span class="news-img-mini"> <img src="<?php echo IMAGES_DIR;?>/hotel3_l.jpg" alt="The Sunset Bali Hotel"></span>
                    <strong><a href="http://bebasterbang.com/theme/index.html#" class="title">Hotel Kuta Paradiso</a></strong><br>
                    <span class="starsin5">5-Stars Hotel</span><br>
                    Bali<br>
                    <span class="redbox">Discount 20%</span><br>
                    <strong>IDR 1.450.000,00</strong> 
