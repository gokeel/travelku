	...
	$.extend(
		...
		{	
			...
			display : function(eleAlignTo)
			{
				...
				//yeste edit karena konflik dengan tinymce ujicoba--------------------------------------------------------------------------------------------------------
				
				var myvdata=$('<div></div>');
				
				var myprev=$('<div class="dp-nav-prev"></div>');
				$(myprev).append($('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '"></a>').bind('click',function(){return c._displayNewMonth.call(c, this, 0, -1);}));
				$(myprev).append($('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"></a>').bind(	'click',function(){	return c._displayNewMonth.call(c, this, -1, 0);	}));
				
				var mynext=$('<div class="dp-nav-next"></div>');
				$(mynext).append($('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '"></a>').bind('click',function(){return c._displayNewMonth.call(c, this, 0, 1);}));
				$(mynext).append($('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"></a>').bind(	'click',function(){	return c._displayNewMonth.call(c, this, 1, 0);	}));
				
				$(myvdata).append($('<h2></h2>'));
				$(myvdata).append(myprev);
				$(myvdata).append(mynext);
				$(myvdata).append($('<div></div>').attr('className', 'dp-calendar'));
				//--------------------------------------------------------------------------------------------------------
				$createIn
					.append(
						$('<div></div>')
