...
jQuery(function() {
"use strict";
	jQuery( "#datepicker,#datepicker2,#datepicker3,#datepicker4,#datepicker5,#datepicker6,#datepicker7,#datepicker8,#datepicker9,#datepicker10,#datepicker11,#datepicker12,#datepicker13,#datepicker14,#datepicker15,#datepicker16" ).datepicker({"dateFormat": "yy-mm-dd"});
});
...
"use strict";
	...
	jQuery('#flight-returning').hide();
	jQuery('#train-returning').hide();
	...
	"use strict";
		jQuery('#flight-returning').hide();
		jQuery('#train-returning').hide();
		jQuery('input#flight-trip').val('single-trip');
		jQuery('input#train-trip').val('single-trip');
		/*jQuery('.hotelstab').addClass('none');
		jQuery('.flightstab').addClass('none');
		jQuery('.vacationstab').addClass('none');
		jQuery('.carstab').addClass('none');
	...
	"use strict";
		jQuery('#flight-returning').show();
		jQuery('#train-returning').show();
		jQuery('input#flight-trip').val('round-trip');
		jQuery('input#train-trip').val('round-trip');
		/*jQuery('.hotelstab').addClass('none');
		jQuery('.flightstab').addClass('none');
		jQuery('.vacationstab').addClass('none');
		jQuery('.carstab').addClass('none');
